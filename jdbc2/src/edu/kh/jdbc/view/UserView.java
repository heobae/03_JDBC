...
public class UserView {
	...
	// view가 Service의 메서드를 활용해 줘야 하기 때문에
	...
	/** 1. User 등록 관련 View
	 * 
	 * switch문 빨간 밑줄 마우스로 만든 메서드 ㅋㅋ
	 */
	private void insertUser() throws Exception { // public 이어도 크게 상관은 없음
		...
		// 빨간 밑줄 create 클릭
		// Service에서 결과반환 받고 생기는 밑줄 throws 해주기
	...
	private void selectAll() throws Exception {
		...
		for(User user : userList) { // 타입 변수명 : 순환대상
			System.out.println(user);
		}
	}
	...
	private void insertUser2() throws Exception {
		...
		String userId = null; // 입렵된 아이디를 저장할 변수
